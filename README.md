...
> **[Live operational monitor](https://manwithacat.github.io/torment-nexus/)** — Interactive console rendering the complete system specification as a tick-based simulation. Toggle platforms, adjust parameters, observe civilisational decline in real time.
...
The complete machine-readable system specification is maintained as a standalone DSL file: **[torment-nexus.dsl](torment-nexus.dsl)**

This specification powers the [interactive operational monitor](https://manwithacat.github.io/torment-nexus/).
...
*System specification rendered in [Dazzle DSL](https://github.com/manwithacat/dazzle) · "If your system is too complex to specify, it's too complex to control."*
